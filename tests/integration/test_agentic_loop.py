...
from nexus.core.types import ExecutionMode, RiskLevel
...
class MockLLMProvider(LLMProvider):
    ...
    async def invoke(self, prompt, system=None, tools=None, temperature=0.7, max_tokens=None, conversation_history=None):
        """Mock invoke."""
        self.call_count += 1
