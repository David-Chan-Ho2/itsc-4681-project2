...
The PNG above (generated by `scripts/generate_diagrams.py`) shows the final implementation architecture. The Mermaid flowcharts below are the canonical planning and implementation records.
