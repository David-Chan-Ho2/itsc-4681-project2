...
Pre-rendered PNGs (generated by `scripts/generate_diagrams.py`):

- ![Scenario 2: Web Research](seq-web-research.png)
- ![Scenario 3: RAG Query](seq-rag-query.png)

The Mermaid sources below are the canonical reference and render on GitHub.
